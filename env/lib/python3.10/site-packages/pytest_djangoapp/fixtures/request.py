...
class DjangoappRequestFactory(RequestFactory):
    ...
    def generic(self, method, path, *args, **kwargs):
        ...
        return super(DjangoappRequestFactory, self).generic(
...
def request_get(request_factory):
    ...
    def request_get_(
        path: str = None, *, user: "AbstractUser" = None, ajax: bool = False, **kwargs
    ) -> "HttpRequest":
    ...
    def request_client_(
        ...
        **kwargs
        ...
        return DjagoappClient(
            ajax=ajax, user=user, raise_exceptions=raise_exceptions, json=json, **kwargs
        )
