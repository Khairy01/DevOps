    ...
    if expected_missing_refs:
        definitions: list[core_schema.CoreSchema] = [
            ...
            core_schema.none_schema(
                ref=ref, metadata={"pydantic_debug_missing_ref": True, "invalid": True}
            )
...
class _WalkCoreSchema:
    ...
    def handle_tuple_variable_schema(
        self,
        schema: core_schema.TupleVariableSchema | core_schema.TuplePositionalSchema,
        f: Walk,
    ) -> core_schema.CoreSchema:
...
def _simplify_schema_references(
    schema: core_schema.CoreSchema, inline: bool
) -> core_schema.CoreSchema:  # noqa: C901
    all_defs: dict[str, core_schema.CoreSchema] = {}

    def make_result(
        schema: core_schema.CoreSchema, defs: Iterable[core_schema.CoreSchema]
    ) -> core_schema.CoreSchema:
